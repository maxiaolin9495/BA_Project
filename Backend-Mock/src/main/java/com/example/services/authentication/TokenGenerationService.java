...
public class TokenGenerationService {
    ...
    private TokenResponse buildToken(String shortTermKey, String maskedVehicleId) throws Exception{
        ...
        byte[] clientPrivateKey = Base64.getDecoder().decode(CLIENT_PRIVATE_KEY);
